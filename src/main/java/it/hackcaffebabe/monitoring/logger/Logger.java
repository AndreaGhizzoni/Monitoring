...
//====================================================================================================//		
	...
	/**
	 * This method show the caller of write method on log.
	 * @param b boolean true show the caller of write method, otherwise false.
	 */
	public void showCaller(boolean b){
		this.showCaller = b;
	}
